...
alias bck_home_cider='rsync ${rsyncopts} --exclude-from=/home/alex/.excludelist --delete /home/alex/ /netwerk/fileserver-home-alex/'
...
mnt_cryptdisk () {
  ...
  sudo mount -o uid=${UID},gid=${UID} /dev/mapper/$1 /mnt/$1
